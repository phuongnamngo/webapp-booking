...
class ConfluenceHint extends React.Component<Props, State> {
  onCreateAccountClick = (e: any) => {
    ...
    if (typeof window !== "undefined") {
      window.open("https://ideskbooking.io/sign-up/");
    }
  };
  ...
  onAdminClick = (e: any) => {
    e.preventDefault();
    if (typeof window !== "undefined") {
      window.open("https://app.ideskbooking.io/admin/");
    }
  };
  ...
  onHelpClick = (e: any) => {
    e.preventDefault();
    if (typeof window !== "undefined") {
      window.open("https://ideskbooking.io/contact/");
    }
  };
      ...
      <div className="container-confluence">
        ...
        <ol>
          <li>
            ...
            >
              {this.props.t("confluenceClientIdStep1")}
            </Button>
          </li>
          <li>
            <Button
            ...
            >
              {this.props.t("confluenceClientIdStep2")}
            </Button>
          </li>
        ...
        <p>
          {this.props.t("confluenceClientIdHint2")}{" "}
          <Button
            variant="link"
            className="button-link"
            onClick={this.onHelpClick}
          >
            {this.props.t("confluenceClientIdHint3")}
          </Button>
        </p>
      </div>
    );
